...
4. Select the option to create a new key and give it a name you will recognize later, such as `polyu-workshop`. This is just a label to distinguish your keys, so you can choose any name.
