...
flowchart LR
    ...
    accDescr: The review analyst and operations advisor independently read the same guest review. The guest reply writer combines both results into a reply draft.
    S["Start · Guest review"] --> A["Review Analyst"]
    S --> B["Operations Advisor"]
    A -->|Feedback analysis| C["Guest Reply Writer"]
