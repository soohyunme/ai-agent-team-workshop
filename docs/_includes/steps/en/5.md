...
**Check the result:** Confirm that the positives and concerns are supported by words in the original review. Improvement proposals or a guest reply would fall outside this agent's role.
